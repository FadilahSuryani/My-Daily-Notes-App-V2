    ...
    <div className="p-2">
      ...
      >
        ...
        {note.title && note.body ? (
          <Button
            className="col-2 btn-outline-warning position-relative start-50 translate-middle-x"
            variant="light"
            type="submit"
          >
            Create New
          ...
          <Button
            className="col-2 btn-outline-dark position-relative start-50 translate-middle-x"
            variant="dark"
            type="submit"
            disabled
          >
